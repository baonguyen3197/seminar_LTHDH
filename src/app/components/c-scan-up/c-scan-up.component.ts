...
@Component({
  selector: 'app-c-scan-up',
  templateUrl: './c-scan-up.component.html',
  styleUrls: ['./c-scan-up.component.scss']
})
export class CScanUpComponent implements OnInit {
  ...
  CSCAN_UP(size: number, head: number) {
    //let seek_count = 0;
  ...
  onClick() {
    console.log(this.CSCAN_UP(this.size, this.head));
